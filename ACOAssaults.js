...
$(document).ready(function(){
    InitNavMenu();
    $(".userinput").focus( HighlightOnFocus );
    $(".userinput").blur( HighlightOffOnBlur );
    $(".userinput").blur( ClearHelpText );
    $(".userinput").blur( DoSearch );
...
function DisplayResults( xml )
{
    ...
    $("ward",xml).each(function(i) {
        $("#appended").append( "<li>" + $(this).find("name").text() + "</li>" );
        count++;
    });
}
